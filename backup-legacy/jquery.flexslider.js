  ...
  $.flexslider = (el, options) => {
    ...
    methods = {
      init: () => {
        ...
        slider.currentSlide = Number.parseInt(slider.vars.startAt ? slider.vars.startAt : 0, 10);
        ...
        if (slider.vars.randomize) {
          slider.slides.sort(() => Math.round(Math.random()) - 0.5);
        ...
        if (
          ...
          ($(slider.containerSelector).length === 1 || slider.vars.multipleKeyboard)
        ) {
