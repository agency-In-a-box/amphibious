...
(() => {
  ...
  var LOADER_BASE_URL = 'http://google-code-prettify.googlecode.com/svn/loader';
  ...
  var prettyPrint = (() => {
    ...
    (() => {
      ...
      function combinePrefixPatterns(regexs) {
        ...
        for (var i = 0, n = regexs.length; i < n; ++i) {
          ...
          if (regex.ignoreCase) {
            ...
            /[a-z]/i.test(regex.source.replace(/\\u[0-9a-f]{4}|\\x[0-9a-f]{2}|\\[^ux]/gi, ''))
          ) {
            needToFoldCase = true;
            ignoreCase = false;
            break;
        ...
        function decodeEscape(charsetPart) {
          ...
          if (cc0) {
            ...
            return Number.parseInt(charsetPart.substring(1), 8);
          } else if (c1 === 'u' || c1 === 'x') {
            return Number.parseInt(charsetPart.substring(2), 16);
          } else {
        ...
        function doWork() {
          ...
          for (; k < elements.length && clock['now']() < endTime; k++) {
            ...
            for (var preceder = cs; (preceder = preceder.previousSibling); ) {
              ...
              if (
                value ? !/^\??prettify\b/.test(value) : nt !== 3 || /\S/.test(preceder.nodeValue)
              ) {
      ...
      if (typeof define === 'function' && define['amd']) {
        define('google-code-prettify', [], () => PR);
      }
    })();
    return prettyPrint;
  })();
