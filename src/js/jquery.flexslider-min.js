  ...
  ($.flexslider = (t, a) => {
    ...
    $.data(t, 'flexslider', n),
      (f = {
        init: () => {
          (n.animating = !1),
            (n.currentSlide = Number.parseInt(n.vars.startAt ? n.vars.startAt : 0, 10)),
            ...
            '' !== n.vars.controlsContainer &&
              (n.controlsContainer =
                $(n.vars.controlsContainer).length > 0 && $(n.vars.controlsContainer)),
            ...
            n.vars.randomize &&
              (n.slides.sort(() => Math.round(Math.random()) - 0.5),
        ...
        controlNav: {
          ...
          setupPaging: () => {
            var e = 'thumbnails' === n.vars.controlNav ? 'control-thumbs' : 'control-paging',
              ...
              s;
            if (
              ((n.controlNavScaffold = $('<ol class="' + i + 'control-nav ' + i + e + '"></ol>')),
              n.pagingCount > 1)
            )
          ...
          function i(e) {
            ...
            if (t) {
              if (t.animatingTo === t.currentSlide && !x && null !== m) {
                ...
                t.canAdvance(n) &&
                ((Number(new Date()) - f < 550 && Math.abs(a) > 50) || Math.abs(a) > c / 2)
            ...
            v
              ...
              n.transitions
                ? ((n.vars.animationLoop && n.atEnd) ||
                  ...
                  n.container.bind('webkitTransitionEnd transitionend', () => {
                ...
                : n.container.animate(n.args, n.vars.animationSpeed, n.vars.easing, () => {
                    n.wrapup(c);
                  });
          }
          ...
          'init' === e &&
            ...
            n.vars.animationLoop &&
              ...
              n.container
                ...
                .prepend(
                  f.uniqueID(n.slides.last().clone().addClass('clone')).attr('aria-hidden', 'true'),
                )),
